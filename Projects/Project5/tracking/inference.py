...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for position in self.allPositions:
            ...
            likelihood = self.getObservationProb(observation, gameState.getPacmanPosition(), position, self.getJailPosition())
            prior = self.beliefs[position]
            
            self.beliefs[position] = likelihood * prior
    ...
    def elapseTime(self, gameState):
        ...
        for position in self.allPositions:
            ...
            for position2, likelihood in self.getPositionDistribution(gameState, position).items():
                new[position2] += self.beliefs[position] * likelihood
...
class ParticleFilter(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for particle in self.particles:
            ...
            new[particle] += self.getObservationProb(observation, gameState.getPacmanPosition(), particle, self.getJailPosition())
    ...
    def elapseTime(self, gameState):
        ...
        for position in self.legalPositions:
            ...
            for position2, likelihood in self.getPositionDistribution(gameState, position).items():
                ...
                new[position2] += beliefs[position] * likelihood
        ...
        for particle in self.particles:
            ...
            for i in range(self.numGhosts):
                ...
                if observation[i] is not None:
                    likelihood *= self.getObservationProb(observation[i], gameState.getPacmanPosition(), particle[i], self.getJailPosition(i))
